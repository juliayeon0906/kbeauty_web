export const STYLISTS_INFO = [{
    STYLISTS : [
        ...
        description: 'Joy ran a hair salon in Sindorim, Korea, for 18 years, gaining extensive experience in the beauty industry while building a loyal client base. She also served as a supervising professor for graduating students in the Department of Beauty at Hyejeon College, where she guided them in mastering a wide range of beauty techniques and preparing for their professional careers. With expertise in all aspects of beauty, She take pride in delivering exceptional results tailored to each client’s unique needs.',
        image: '/src/assets/images/STYLISTS/BBB.jpg'
        },
        {
            name: 'Esther',
        position: 'Master Stylist',
        description: 'Esther has extensive hands-on experience as a nail technician and hairstylist in Korea\'s dynamic beauty industry. Since settling in Halifax in 2024, she has brought cutting-edge expertise in trendy Korean beauty techniques, including haircuts tailored to various textures and lengths, hair coloring, highlights, Korean perms, and treatments.' 
        + '\n' 
        ...
        image: '/src/assets/images/STYLISTS/CCC.jpg'
        },
        {
            name: 'Lucy',
        position: 'Master Stylist',
        description: 'With over 20 years of experience in the beauty industry, Lucy brings extensive expertise to her work. She has styled K-pop stars in Korea, collaborated on fashion magazine shoots, and managed her own salon in Seoul as CEO. After graduating from the Shiseido Beauty Academy in Japan, she further expanded her skills through experiences in Japan, Australia, and Vancouver. Lucy is proficient in all areas of styling, including cuts, perms, coloring, treatments, and updos. She is excited to offer her top-quality services at K-Beauty.',
        image: '/src/assets/images/STYLISTS/AAA.jpg'
        },
        {
            name: 'Ellie',
            position: 'Master Stylist',
